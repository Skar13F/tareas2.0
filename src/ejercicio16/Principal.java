 ...
 * 				imprime el resultado obtenido y un mensaje de acuerdo a la cantidad de puntos
 */
package ejercicio16;
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		par.setRespuesta(s.nextLine());
		if (par.getRespuesta().equalsIgnoreCase("v")) {
			par.setPuntos(par.getPuntos() + 3);
		}
		...
		if ((par.getPuntos() > 11) && (par.getPuntos() <= 22)) {
			System.out.print(
